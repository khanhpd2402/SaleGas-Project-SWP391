            ...
            <nav class="navbar navbar-expand-sm navbar-default">
                ...
                <div id="main-menu" class="main-menu collapse navbar-collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <c:if test="${employeeinfo.getRole() == 1}">
                            ...
                            <li>
                                <a href="listAdminServlet?role=0"> <i class="menu-icon fas fa-users"></i>Danh Sách Quản Trị Viên</a>
                            </li>
                            <li>
                                <a href="listAdminServlet?role=1"> <i class="menu-icon fas fa-user-cog"></i>Danh Sách QTV C1 </a>
                            </li>
                            <li class="menu-item-has-children dropdown">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> 
                                    <i class="menu-icon fas fa-male"></i>Danh Sách QTV C2</a>
                                <ul class="sub-menu children dropdown-menu">
                                    <li><i class="fa fa-id-badge"></i><a href="listAdminServlet?role=2">Danh Sách QTV Khách Hàng,Tin Tức</a></li>
                                    <li><i class="fa fa-id-badge"></i><a href="listAdminServlet?role=3">Danh Sách QTV Sản Phẩm,Doanh Số</a></li>
                                    <li><i class="fa fa-id-badge"></i><a href="listAdminServlet?role=4">Danh Sách QTV Đơn Hàng,Bảo Hành</a></li>
                                </ul>
                            </li>
                        </c:if>
                        <c:if test="${employeeinfo.getRole() == 2 || employeeinfo.getRole() == 1}">
                            ...
                            <li>
                                <a href="listnews"> <i class="menu-icon fa fa-calendar-o"></i> Danh Sách Tin Tức</a>
                            </li>
                            <li>
                                <a href="addnews"> <i class="menu-icon fa fa-calendar-o"></i>Thêm Tin Tức</a>
                            </li>
                        </c:if>
                        <c:if test="${employeeinfo.getRole() == 1}">
                        ...
                        <c:if test="${employeeinfo.getRole() == 3 || employeeinfo.getRole() == 1}">
                        ...
                        <c:if test="${employeeinfo.getRole() == 4 || employeeinfo.getRole() == 1}">
